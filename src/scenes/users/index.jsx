...
import { Box, Button, TextField, useTheme, Avatar, Dialog, DialogActions, DialogContent, DialogTitle } from "@mui/material";
  ...
  const columns = [
    {
      ...
      renderCell: (params) => (
        <Box display="flex" alignItems="center" gap={1}>
          <Avatar src={params.row.profilePicture} alt={params.row.displayName} sx={{ width: 32, height: 32 }} />
          {params.value}
        </Box>
      ),
    },
    { field: "walletAmount", headerName: "Portefeuille", flex: 1, minWidth: 120 },
    { field: "score", headerName: "Score", flex: 1, minWidth: 100 },
    { field: "bestScore", headerName: "Meilleur score", flex: 1, minWidth: 120 },
    {
      field: "actions",
      headerName: "Actions",
      flex: 1,
  ...
  return (
    <Box m="1.5rem 2.5rem">
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          <p>Êtes-vous sûr(e) de vouloir supprimer cet utilisateur ? Cette action est irréversible.</p>
        </DialogContent>
        <DialogActions>
