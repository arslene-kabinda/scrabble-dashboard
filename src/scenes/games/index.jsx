						...
						<div className="grid grid-cols-2 gap">
							{paginatedGames.map((game) => {
								...
								return (
									<div
										key={game.id}
										className="w-full grid grid-cols-3 gap-5 border gap padding"
									>
										<UserGame details={firstUser} />
										<div className="w-full flex flex-col items-center justify-center gap-2">
											<div
												className={`w-fit px-3 py-1 text-xs rounded-xl ${
