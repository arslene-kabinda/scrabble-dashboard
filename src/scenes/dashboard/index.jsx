...
const Dashboard = () => {
	...
	const fetchData = async (url, setState, key) => {
		...
		try {
			...
			setError((prev) => ({
				...prev,
				[key]: "Erreur lors de la récupération des données.",
			}));
	...
	const fetchWalletData = async () => {
		...
		try {
			...
			setError((prev) => ({
				...prev,
				wallet: "Erreur lors de la récupération des données du portefeuille.",
			}));
	...
	const fetchWalletAmount = async () => {
		...
		try {
			...
			setError((prev) => ({
				...prev,
				wallet: "Erreur lors de la récupération du montant du portefeuille.",
			}));
		...
		<Box m="1.5rem 2.5rem">
			...
			>
				...
				>
					...
					<div className="p-8">
						<Link className="w-fit underline" to={"/app-wallet"}>
							Voir les détails
						</Link>
					</div>
				</Box>
